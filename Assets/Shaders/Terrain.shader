...
Shader "Terrain"
{
	Properties
	{
		...
		_ColorVariation("Color Variation", 2D) = "white" {}
		_Grass1Norm("Grass 1 Norm", 2D) = "bump" {}
		_Grass1NearTile("Grass 1 Near Tile", Range( 0 , 100)) = 100
		_Grass1FarTile("Grass 1 Far Tile", Range( 0 , 100)) = 10
		_AntiTile1("Anti Tile 1", Float) = 0.002
		_AntiTile2("Anti Tile 2", Float) = 0.5
		_AntiTile3("Anti Tile 3", Float) = 0.2
		_Grass1Normal("Grass 1 Normal", Range( 0 , 6)) = 1
		_Distance("Distance", Float) = 100
		[ASEEnd]_Falloff("Falloff", Float) = 20
	...
	SubShader
	{
		...
		Pass
		{
			...
			float _AntiTile2;
			float _AntiTile3;
			float _Grass1NearTile;
			float _Grass1FarTile;
			float _Distance;
			float _Falloff;
			float _Grass1Normal;
			...
			#endif
			CBUFFER_END
			sampler2D _ColorVariation;
			sampler2D _Grass1;
			sampler2D _Grass1Norm;
						 ...
						 ) : SV_Target
			{
				...
				float2 texCoord4_g1 = IN.ase_texcoord8.xy * temp_cast_0 + float2( 0,0 );
				float2 temp_cast_1 = (_AntiTile2).xx;
				float2 texCoord5_g1 = IN.ase_texcoord8.xy * temp_cast_1 + float2( 0,0 );
				float2 temp_cast_2 = (_AntiTile3).xx;
				float2 texCoord6_g1 = IN.ase_texcoord8.xy * temp_cast_2 + float2( 0,0 );
				float3 lerpResult16_g1 = lerp( float3(0.5,0.5,0.5) , float3( 1,1,1 ) , ( ( ( tex2D( _ColorVariation, texCoord4_g1 ).r + 0.0 ) * ( tex2D( _ColorVariation, texCoord5_g1 ).r + 0.5 ) ) * ( tex2D( _ColorVariation, texCoord6_g1 ).r + 0.5 ) ));
				float3 ColorVariation18 = lerpResult16_g1;
				float2 temp_cast_4 = (_Grass1NearTile).xx;
				float2 texCoord12 = IN.ase_texcoord8.xy * temp_cast_4 + float2( 0,0 );
				float2 temp_cast_5 = (_Grass1FarTile).xx;
				float2 texCoord31 = IN.ase_texcoord8.xy * temp_cast_5 + float2( 0,0 );
				float clampResult10_g2 = clamp( pow( ( distance( WorldPosition , _WorldSpaceCameraPos ) / _Distance ) , _Falloff ) , 0.0 , 1.0 );
				float DistanceBlend25 = clampResult10_g2;
				float4 lerpResult34 = lerp( tex2D( _Grass1, texCoord12 ) , tex2D( _Grass1, texCoord31 ) , DistanceBlend25);
				float4 Grass128 = ( float4( ColorVariation18 , 0.0 ) * lerpResult34 );
				
				float3 unpack11 = UnpackNormalScale( tex2D( _Grass1Norm, texCoord12 ), _Grass1Normal );
				unpack11.z = lerp( 1, unpack11.z, saturate(_Grass1Normal) );
				float3 unpack33 = UnpackNormalScale( tex2D( _Grass1Norm, texCoord31 ), _Grass1Normal );
				unpack33.z = lerp( 1, unpack33.z, saturate(_Grass1Normal) );
				float3 lerpResult36 = lerp( unpack11 , unpack33 , DistanceBlend25);
				float3 Grass1Norm38 = lerpResult36;
				
				float3 Albedo = Grass128.rgb;
				float3 Normal = Grass1Norm38;
				float3 Emission = 0;
				float3 Specular = 0.5;
				float Metallic = 0;
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float2 temp_cast_0 = (_AntiTile1).xx;
				float2 texCoord4_g1 = IN.ase_texcoord4.xy * temp_cast_0 + float2( 0,0 );
				float2 temp_cast_1 = (_AntiTile2).xx;
				float2 texCoord5_g1 = IN.ase_texcoord4.xy * temp_cast_1 + float2( 0,0 );
				float2 temp_cast_2 = (_AntiTile3).xx;
				float2 texCoord6_g1 = IN.ase_texcoord4.xy * temp_cast_2 + float2( 0,0 );
				float3 lerpResult16_g1 = lerp( float3(0.5,0.5,0.5) , float3( 1,1,1 ) , ( ( ( tex2D( _ColorVariation, texCoord4_g1 ).r + 0.0 ) * ( tex2D( _ColorVariation, texCoord5_g1 ).r + 0.5 ) ) * ( tex2D( _ColorVariation, texCoord6_g1 ).r + 0.5 ) ));
				float3 ColorVariation18 = lerpResult16_g1;
				float2 temp_cast_4 = (_Grass1NearTile).xx;
				float2 texCoord12 = IN.ase_texcoord4.xy * temp_cast_4 + float2( 0,0 );
				float2 temp_cast_5 = (_Grass1FarTile).xx;
				float2 texCoord31 = IN.ase_texcoord4.xy * temp_cast_5 + float2( 0,0 );
				float clampResult10_g2 = clamp( pow( ( distance( WorldPosition , _WorldSpaceCameraPos ) / _Distance ) , _Falloff ) , 0.0 , 1.0 );
				float DistanceBlend25 = clampResult10_g2;
				float4 lerpResult34 = lerp( tex2D( _Grass1, texCoord12 ) , tex2D( _Grass1, texCoord31 ) , DistanceBlend25);
				float4 Grass128 = ( float4( ColorVariation18 , 0.0 ) * lerpResult34 );
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float2 temp_cast_0 = (_AntiTile1).xx;
				float2 texCoord4_g1 = IN.ase_texcoord2.xy * temp_cast_0 + float2( 0,0 );
				float2 temp_cast_1 = (_AntiTile2).xx;
				float2 texCoord5_g1 = IN.ase_texcoord2.xy * temp_cast_1 + float2( 0,0 );
				float2 temp_cast_2 = (_AntiTile3).xx;
				float2 texCoord6_g1 = IN.ase_texcoord2.xy * temp_cast_2 + float2( 0,0 );
				float3 lerpResult16_g1 = lerp( float3(0.5,0.5,0.5) , float3( 1,1,1 ) , ( ( ( tex2D( _ColorVariation, texCoord4_g1 ).r + 0.0 ) * ( tex2D( _ColorVariation, texCoord5_g1 ).r + 0.5 ) ) * ( tex2D( _ColorVariation, texCoord6_g1 ).r + 0.5 ) ));
				float3 ColorVariation18 = lerpResult16_g1;
				float2 temp_cast_4 = (_Grass1NearTile).xx;
				float2 texCoord12 = IN.ase_texcoord2.xy * temp_cast_4 + float2( 0,0 );
				float2 temp_cast_5 = (_Grass1FarTile).xx;
				float2 texCoord31 = IN.ase_texcoord2.xy * temp_cast_5 + float2( 0,0 );
				float clampResult10_g2 = clamp( pow( ( distance( WorldPosition , _WorldSpaceCameraPos ) / _Distance ) , _Falloff ) , 0.0 , 1.0 );
				float DistanceBlend25 = clampResult10_g2;
				float4 lerpResult34 = lerp( tex2D( _Grass1, texCoord12 ) , tex2D( _Grass1, texCoord31 ) , DistanceBlend25);
				float4 Grass128 = ( float4( ColorVariation18 , 0.0 ) * lerpResult34 );
		...
		Pass
		{
						 ...
						 ) : SV_TARGET
			{
				...
				float2 temp_cast_0 = (_Grass1NearTile).xx;
				float2 texCoord12 = IN.ase_texcoord4.xy * temp_cast_0 + float2( 0,0 );
				float3 unpack11 = UnpackNormalScale( tex2D( _Grass1Norm, texCoord12 ), _Grass1Normal );
				unpack11.z = lerp( 1, unpack11.z, saturate(_Grass1Normal) );
				float2 temp_cast_1 = (_Grass1FarTile).xx;
				float2 texCoord31 = IN.ase_texcoord4.xy * temp_cast_1 + float2( 0,0 );
				float3 unpack33 = UnpackNormalScale( tex2D( _Grass1Norm, texCoord31 ), _Grass1Normal );
				unpack33.z = lerp( 1, unpack33.z, saturate(_Grass1Normal) );
				float clampResult10_g2 = clamp( pow( ( distance( WorldPosition , _WorldSpaceCameraPos ) / _Distance ) , _Falloff ) , 0.0 , 1.0 );
				float DistanceBlend25 = clampResult10_g2;
...
/*ASEBEGIN
Version=18935
-2042;-70;1920;1001;453.5157;186.826;1;True;True
Node;AmplifyShaderEditor.CommentaryNode;27;-1268.262,-521.3885;Inherit;False;783.3644;315.3592;;5;15;17;16;18;14;Anti Tiling;1,1,1,1;0;0
Node;AmplifyShaderEditor.CommentaryNode;26;-467.5808,-523.9216;Inherit;False;747;248;;4;22;24;23;25;Distance Falloff;1,1,1,1;0;0
Node;AmplifyShaderEditor.GetLocalVarNode;35;-342.3576,454.7021;Inherit;False;25;DistanceBlend;1;0;OBJECT;;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;24;-417.5808,-473.9216;Inherit;False;Property;_Falloff;Falloff;11;0;Create;True;0;0;0;False;0;False;20;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;20;33.29819,-83.16251;Inherit;False;18;ColorVariation;1;0;OBJECT;;False;1;FLOAT3;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;19;253.2982,26.83752;Inherit;False;2;2;0;FLOAT3;0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.LerpOp;36;-8.409357,490.7472;Inherit;False;3;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;2;FLOAT;0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.LerpOp;34;-8.783073,248.5664;Inherit;False;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.GetLocalVarNode;40;577.4843,352.174;Inherit;False;38;Grass1Norm;1;0;OBJECT;;False;1;FLOAT3;0
Node;AmplifyShaderEditor.SamplerNode;10;-405.9574,0.6322932;Inherit;True;Property;_Grass1;Grass 1;0;0;Create;True;0;0;0;False;0;False;-1;2923c788e2dcf2446a6e26d9cc01f6d4;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;32;-422.7678,578.6577;Inherit;True;Property;_TextureSample1;Texture Sample 1;0;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Instance;10;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;23;-414.5808,-391.9216;Inherit;False;Property;_Distance;Distance;10;0;Create;True;0;0;0;False;0;False;100;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;11;-408,197.5;Inherit;True;Property;_Grass1Norm;Grass 1 Norm;3;0;Create;True;0;0;0;False;0;False;-1;e1c53d8265c81f641b19868d12517221;None;True;0;True;bump;Auto;True;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;21;-748.5107,314.9362;Inherit;False;Property;_Grass1Normal;Grass 1 Normal;9;0;Create;True;0;0;0;False;0;False;1;0;0;6;0;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;22;-233.6583,-420.9169;Inherit;False;Distance Blend;-1;;2;88ba7035e37eda846926b1a01452d6fd;0;2;8;FLOAT;20;False;9;FLOAT;100;False;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;33;-424.671,773.6686;Inherit;True;Property;_TextureSample0;Texture Sample 0;3;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;True;Instance;11;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RegisterLocalVarNode;25;55.41919,-417.9216;Inherit;False;DistanceBlend;-1;True;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RegisterLocalVarNode;38;170.4843,483.1741;Inherit;False;Grass1Norm;-1;True;1;0;FLOAT3;0,0,0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.RegisterLocalVarNode;18;-708.8975,-412.592;Inherit;False;ColorVariation;-1;True;1;0;FLOAT3;0,0,0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.RangedFloatNode;30;-1051.853,599.0207;Inherit;False;Property;_Grass1FarTile;Grass 1 Far Tile;5;0;Create;True;0;0;0;False;0;False;10;1;0;100;0;1;FLOAT;0
Node;AmplifyShaderEditor.TextureCoordinatesNode;31;-737.8533,605.0207;Inherit;False;0;-1;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.TextureCoordinatesNode;12;-689,112.5;Inherit;False;0;-1;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;13;-1018,23.5;Inherit;False;Property;_Grass1NearTile;Grass 1 Near Tile;4;0;Create;True;0;0;0;False;0;False;100;1;0;100;0;1;FLOAT;0
Node;AmplifyShaderEditor.RegisterLocalVarNode;28;399.3024,23.88137;Inherit;False;Grass1;-1;True;1;0;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.GetLocalVarNode;39;560.4843,244.174;Inherit;False;28;Grass1;1;0;OBJECT;;False;1;COLOR;0
Node;AmplifyShaderEditor.RangedFloatNode;16;-1204.754,-396.0293;Inherit;False;Property;_AntiTile2;Anti Tile 2;7;0;Create;True;0;0;0;False;0;False;0.5;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;17;-1202.754,-322.0293;Inherit;False;Property;_AntiTile3;Anti Tile 3;8;0;Create;True;0;0;0;False;0;False;0.2;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;15;-1218.262,-471.3885;Inherit;False;Property;_AntiTile1;Anti Tile 1;6;0;Create;True;0;0;0;False;0;False;0.002;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;14;-951.262,-407.4886;Inherit;False;Anti Tiling;1;;1;a735a97f0d559b1468e7cd12445d61f5;0;3;7;FLOAT;0.02;False;8;FLOAT;0.2;False;9;FLOAT;2;False;1;FLOAT3;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;1;877.7,279.4;Float;False;True;-1;2;UnityEditor.ShaderGraphLitGUI;0;2;Terrain;94348b07e5e8bab40bd6c8a1e3df54cd;True;Forward;0;1;Forward;19;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;-1;False;True;0;False;-1;False;False;False;False;False;False;False;False;False;True;False;255;False;-1;255;False;-1;255;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;False;True;1;False;-1;True;3;False;-1;True;True;0;False;-1;0;False;-1;True;3;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;2;True;17;d3d9;d3d11;glcore;gles;gles3;metal;vulkan;xbox360;xboxone;xboxseries;ps4;playstation;psp2;n3ds;wiiu;switch;nomrt;0;False;True;1;1;False;-1;0;False;-1;1;1;False;-1;0;False;-1;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;True;True;True;True;0;False;-1;False;False;False;False;False;False;False;True;False;255;False;-1;255;False;-1;255;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;False;False;False;False;True;1;LightMode=UniversalForward;False;False;0;Hidden/InternalErrorShader;0;0;Standard;40;Workflow;1;0;Surface;0;0;  Refraction Model;0;0;  Blend;0;0;Two Sided;1;0;Fragment Normal Space,InvertActionOnDeselection;0;0;Transmission;0;0;  Transmission Shadow;0.5,False,-1;0;Translucency;0;0;  Translucency Strength;1,False,-1;0;  Normal Distortion;0.5,False,-1;0;  Scattering;2,False,-1;0;  Direct;0.9,False,-1;0;  Ambient;0.1,False,-1;0;  Shadow;0.5,False,-1;0;Cast Shadows;1;0;  Use Shadow Threshold;0;0;Receive Shadows;1;0;GPU Instancing;1;0;LOD CrossFade;1;0;Built-in Fog;1;0;_FinalColorxAlpha;0;0;Meta Pass;1;0;Override Baked GI;0;0;Extra Pre Pass;0;0;DOTS Instancing;0;0;Tessellation;0;0;  Phong;0;0;  Strength;0.5,False,-1;0;  Type;0;0;  Tess;16,False,-1;0;  Min;10,False,-1;0;  Max;25,False,-1;0;  Edge Length;16,False,-1;0;  Max Displacement;25,False,-1;0;Write Depth;0;0;  Early Z;0;0;Vertex Position,InvertActionOnDeselection;1;0;Debug Display;0;0;Clear Coat;0;0;0;10;False;True;True;True;True;True;True;True;True;True;False;;False;0
...
WireConnection;14;8;16;0
WireConnection;14;9;17;0
WireConnection;1;0;39;0
WireConnection;1;1;40;0
ASEEND*/
//CHKSM=F86E0D29F0538BC5BCFD194BBF30C459F608BD7B