	...
	SubShader
	{
		...
		Pass
		{
						 ...
						 ) : SV_Target
			{
				...
				float2 texCoord4_g3 = IN.ase_texcoord8.xy * temp_cast_0 + float2( 0,0 );
				float2 temp_cast_1 = (_AntiTile2).xx;
				float2 texCoord5_g3 = IN.ase_texcoord8.xy * temp_cast_1 + float2( 0,0 );
				float2 temp_cast_2 = (_AntiTile3).xx;
				float2 texCoord6_g3 = IN.ase_texcoord8.xy * temp_cast_2 + float2( 0,0 );
				float3 lerpResult16_g3 = lerp( float3(0.5,0.5,0.5) , float3( 1,1,1 ) , ( ( ( tex2D( _ColorVariation, texCoord4_g3 ).r + 0.0 ) * ( tex2D( _ColorVariation, texCoord5_g3 ).r + 0.5 ) ) * ( tex2D( _ColorVariation, texCoord6_g3 ).r + 0.5 ) ));
				float3 ColorVariation18 = lerpResult16_g3;
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float2 temp_cast_0 = (_AntiTile1).xx;
				float2 texCoord4_g3 = IN.ase_texcoord4.xy * temp_cast_0 + float2( 0,0 );
				float2 temp_cast_1 = (_AntiTile2).xx;
				float2 texCoord5_g3 = IN.ase_texcoord4.xy * temp_cast_1 + float2( 0,0 );
				float2 temp_cast_2 = (_AntiTile3).xx;
				float2 texCoord6_g3 = IN.ase_texcoord4.xy * temp_cast_2 + float2( 0,0 );
				float3 lerpResult16_g3 = lerp( float3(0.5,0.5,0.5) , float3( 1,1,1 ) , ( ( ( tex2D( _ColorVariation, texCoord4_g3 ).r + 0.0 ) * ( tex2D( _ColorVariation, texCoord5_g3 ).r + 0.5 ) ) * ( tex2D( _ColorVariation, texCoord6_g3 ).r + 0.5 ) ));
				float3 ColorVariation18 = lerpResult16_g3;
				float2 temp_cast_4 = (_Grass1NearTile).xx;
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float2 temp_cast_0 = (_AntiTile1).xx;
				float2 texCoord4_g3 = IN.ase_texcoord2.xy * temp_cast_0 + float2( 0,0 );
				float2 temp_cast_1 = (_AntiTile2).xx;
				float2 texCoord5_g3 = IN.ase_texcoord2.xy * temp_cast_1 + float2( 0,0 );
				float2 temp_cast_2 = (_AntiTile3).xx;
				float2 texCoord6_g3 = IN.ase_texcoord2.xy * temp_cast_2 + float2( 0,0 );
				float3 lerpResult16_g3 = lerp( float3(0.5,0.5,0.5) , float3( 1,1,1 ) , ( ( ( tex2D( _ColorVariation, texCoord4_g3 ).r + 0.0 ) * ( tex2D( _ColorVariation, texCoord5_g3 ).r + 0.5 ) ) * ( tex2D( _ColorVariation, texCoord6_g3 ).r + 0.5 ) ));
				float3 ColorVariation18 = lerpResult16_g3;
				float2 temp_cast_4 = (_Grass1NearTile).xx;
...
/*ASEBEGIN
Version=18935
504.8;259.2;1324.8;750.2;155.9157;59.02602;1;False;True
...
Node;AmplifyShaderEditor.FunctionNode;14;-951.262,-407.4886;Inherit;False;Anti Tiling;1;;3;a735a97f0d559b1468e7cd12445d61f5;0;3;7;FLOAT;0.02;False;8;FLOAT;0.2;False;9;FLOAT;2;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.SamplerNode;10;-405.9574,0.6322932;Inherit;True;Property;_Grass1;Grass 1;0;0;Create;True;0;0;0;False;0;False;-1;2923c788e2dcf2446a6e26d9cc01f6d4;2923c788e2dcf2446a6e26d9cc01f6d4;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
ASEEND*/
//CHKSM=1407FA0C57D80480926B26433FCDC42F428AA9FD